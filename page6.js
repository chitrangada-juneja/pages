...
const App = () => (
  <div style={{ display: 'flex', justifyContent: 'center', backgroundColor: '#f0f2f5', minHeight: '100vh', padding: '32px 16px' }}>
    <Card title={<span style={{ fontSize: 20, fontWeight: 'bold', display: 'flex', alignItems: 'center' }}><QuestionCircleOutlined style={{ marginRight: 8 }} /> Interview Preparation</span>}
